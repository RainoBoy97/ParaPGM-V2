    ...
    public static String getEntityString(Entity entity) {
        ...
        switch(entity.getType()) {
            ...
            case PIG_ZOMBIE:
                ...
                break;
            case PLAYER:
                name = AboutPlayer.getPlayer(((Player) entity)) != null
                		? AboutPlayer.getPlayer(((Player) entity)).getTeam().getColor() + AboutPlayer.getPlayer(((Player) entity)).getPlayer().getName()
